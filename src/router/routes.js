...
const routes = [
	...
	//公共布局下的路由
	{
		...
		children: [{
			...
			// 自己的公司信息管理
			{
				path: '/informat/company',
				component: () => import('@/views/informat/Company'),
				meta: {
					auth: true,
					name: "公司信息管理"
				}
			...
			// 自己的仓库信息管理
			{
				path: '/informat/warehouse',
				component: () => import('@/views/informat/Warehouse'),
				meta: {
					auth: true,
					name: "仓库信息管理"
				}
			...
			// 自己的货物管理
			{
				...
				component: () => import('@/views/transportation/Goods'),
				meta: {
					auth: true,
					name: "货物管理"
				}
			...
			// 自己的采购物资管理
			{
				...
				component: () => import('@/views//warehouse/Supply'),
				meta: {
					auth: true,
					name: "采购物资管理"
				}
